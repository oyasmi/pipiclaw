...
const LATIN_STOP_WORDS = new Set([
	...
	"does", "doing", "for", "from", "had", "has", "have", "here", "how", "i", "in", "is", "it", "its",
	"me", "my", "of", "on", "or", "our", "please", "should", "that", "the", "their", "them", "there",
	"these", "they", "this", "to", "was", "we", "were", "what", "when", "where", "which", "who", "why",
	"with", "would", "you", "your",
]);

const CHINESE_STOP_CHARS = new Set([
	"的", "了", "在", "是", "有", "不", "和", "与", "个", "把", "被", "从", "对", "而", "给", "将", "就",
	"让", "向", "也", "以", "因", "又", "于", "则", "之", "这", "那", "其", "它", "他", "她", "们", "都",
	"要", "会", "能", "很", "得", "地", "着", "过", "吗", "呢", "吧", "啊", "哦", "嗯", "呀",
]);
